  ...
  return (
    <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
      ...
      >
        <div className="felx felx-col md:items-start items-center w-full">
          ...
          <p className="mt-6 text-center md:text-left text-sm text-white/80">
            Shaping the future of tech education with immersive, hands-on <br />
            learning experiences built for tomorrow’s challenges.
          </p>
        </div>
        ...
        <div className="hidden md:flex flex-col items-start w-full">
          ...
          <p className="text-sm text-white/80">
            The latest news, articles, and resources are sent to your inbox
            weekly.
          </p>
      ...
      <p className="py-4 text-center text-xs md:text-sm text-white/60">
        {" "}
        Copyright 2025 © Courseify. All Right Reserved
      </p>
    </footer>
  );
};
